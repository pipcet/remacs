...
fn hash_alg(algorithm: LispObject) -> HashAlg {
    ...
    if algorithm.eq(Qmd5) {
        HashAlg::MD5
    } else if algorithm.eq(Qsha1) {
        HashAlg::SHA1
    } else if algorithm.eq(Qsha224) {
        HashAlg::SHA224
    } else if algorithm.eq(Qsha256) {
        HashAlg::SHA256
    } else if algorithm.eq(Qsha384) {
        HashAlg::SHA384
    } else if algorithm.eq(Qsha512) {
        HashAlg::SHA512
    } else {
